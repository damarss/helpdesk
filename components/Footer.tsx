...
const helpMenus: Menu[] = [
  ...
  },
  {
    id: 5,
    name: 'Kontak Kami',
    url: 'mailto:dipdopdep@gmail.com',
  },
];
...
const Footer = () => {
  ...
  return (
    <footer className='bg-grey-base pt-8 w-full mt-auto px-8'>
      <div className='container mx-auto'>
        <div className='flex flex-wrap md:flex-nowrap items-start'>
          <div className='flex items-center md:items-start md:flex-auto flex-col w-full px-4'>
            ...
            <div className='my-6 font-semibold text-sm leading-8 text-grey-mid hidden lg:block'>
              {' '}
              Copyright &copy; Politeknik Statistika STIS 2023
            </div>
          </div>
          ...
          <div className='w-full md:w-auto flex flex-wrap md:flex-nowrap justify-center md:justify-end mt-6 md:mt-0 px-6 md:space-x-4'>
            <div className='flex flex-col items-center mb-6 md:items-start px-4 md:px-6 md:w-[13rem] '>
              <span className='font-bold text-sm leading-7 text-black-base'>
                Pertanyaan
              </span>
      ...
      <div className='text-center font-semibold mt-6 text-sm leading-6 text-grey-mid lg:hidden'>
        {' '}
        Copyright &copy; Politeknik Statistika STIS 2023
      </div>
    </footer>
